...
export function FilaPedidos({ pedidos }: FilaPedidosProps) {
  return (
    ...
    <div className="p-4 flex justify-between items-center text-sm text-gray-600 border-t border-gray-200">
          <button className="px-3 py-1 rounded-md border border-gray-300 hover:bg-gray-200">Anterior</button>
          <span>Pagina 1 de 1</span>
          <button className="px-3 py-1 rounded-md border border-gray-300 hover:bg-gray-200">Proximo</button>
    </div>
  </div>
  )
}